...
<div id='mainButtonDiv'>
	...
	<input type='button' value='Launch the game' name='CityManagement'
		class='mainButtons link' /> 
	<input type='button' value='Rules'
		name='Rules' class='mainButtons link' /> 
	<?php 
	...
	?>
	<input type='button' value='Exit game'
		name='ExitGame' id='ExitGame' class='mainButtons link' />
</div>