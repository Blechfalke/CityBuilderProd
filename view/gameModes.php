...
<div id="mainButtonDiv">
	...
	<input type="button" value="5 turns mode" name="startMenu" class="mainButtons gameMode" id="3"/> 
	<input type="button" value="Infinite turns mode" name="startMenu" class="mainButtons gameMode" id="4" />
</div>
